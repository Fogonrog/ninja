...
public class SpriteTexture {
    ...
    /**
     * Получить i-ый фрейм c размерами, умноженными на zoom, в линии line
     */
    public Bitmap getScaledFrame(int line, int i, float zoom) {
        Bitmap f = getFrame(line, i);
        return Bitmap.createScaledBitmap(f, (int) (zoom * f.getWidth()), (int) (zoom * f.getHeight()), true);
    }
